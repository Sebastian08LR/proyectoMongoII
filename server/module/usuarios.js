...
export class Usuarios {
     ...
     *
     * @param {Array} params - Array containing userName, password, rol, email, tarjeta_vip.
    ...
    async createUser([userName, password, rol, email, tarjeta_vip]) {
        try {
            ...
            const userDocument = {
                id: LastUserRegister ? LastUserRegister.id + 1 : 1,
                nombre: userName,
                email: email,
                rol: rol,
     ...
     *
     * @param {Array} params - Array containing userName and newRole.
     * @returns {Promise<void>}
     */
    ...
    /**
     * This function is responsible for retrieving the details of a specific user.
     *
     * @param {Array} params - Array containing user_id.
     * @returns {Promise<void>}
     */
